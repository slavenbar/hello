...
func main() {
	...
	c.OnHTML("a[href]", func(e *colly.HTMLElement) {
		...
		if !strings.HasPrefix(link, "/cocktails1") || strings.Index(link, "=signup") > -1 || strings.Index(link, "=login") > -1 {
			return
		}
	...
	c.OnHTML(`a.ingredient-tables`, func(e *colly.HTMLElement) {
		// Activate detailCollector if the link contains "coursera.org/learn"
		courseURL := e.Request.AbsoluteURL(e.Attr("href"))
		if strings.Index(courseURL, "ru.inshaker.com/cocktails") != -1 {
